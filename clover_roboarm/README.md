...
Với bộ mã và hướng dẫn trên, bạn có thể triển khai ngay trên Raspberry Pi 4 chạy Clover, kiểm thử an toàn bằng các demo có sẵn, và vận hành song song với các node ROS khác mà không phá vỡ functionality hiện có.