...
- Chạy launch:
  roslaunch clover_road_following dataset_logger.launch out_dir:=/path/to/dataset
...
- Chạy:
  roslaunch clover_road_following inference.launch \
...
- Node:
  ...
  - Có service toggle: /road_following/toggle (std_srvs/SetBool)
...
roslaunch clover_road_following dataset_logger.launch out_dir:=/home/phuoc/datasets/road_following/data image_topic:=/main_camera/image_raw cmd_twist_topics:=/mavros/setpoint_velocity/cmd_vel_unstamped cmd_timeout:=0.5 save_stride:=1