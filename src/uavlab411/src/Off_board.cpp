...
OffBoardOut::OffBoardOut()
{
    sub_state = nh.subscribe<mavros_msgs::State>("mavros/state", 1, &OffBoardOut::handleState, this);
    sub_uavpose = nh.subscribe<geometry_msgs::PoseStamped>("uavlab411/uavpose", 1, &OffBoardOut::handlePoses, this);
    sub_local_position = nh.subscribe<geometry_msgs::PoseStamped>("mavros/local_position/pose", 1, &OffBoardOut::handleLocalPosition, this);
    sub_global_position = nh.subscribe<sensor_msgs::NavSatFix>("/mavros/global_position/global", 1, &OffBoardOut::handleGlobalPosition, this);
    sub_imu_data = nh.subscribe<sensor_msgs::Imu>("/mavros/imu/data", 1, &OffBoardOut::handleImuData, this);
    sub_relative_alt = nh.subscribe<std_msgs::Float64>("/mavros/global_position/rel_alt", 1, &OffBoardOut::handleRelativeAlt, this);
    ...
    navigate_srv = nh.advertiseService("uavlab411/navigate", &OffBoardOut::Navigate, this);
    navigateGlobal_srv = nh.advertiseService("uavlab411/navigate_global", &OffBoardOut::NavigateGlobal, this);
    pid_tuning_srv = nh.advertiseService("uavlab411/pid_tuning", &OffBoardOut::TuningPID, this);
    takeoff_srv = nh.advertiseService("uavlab411/takeoff", &OffBoardOut::TakeoffSrv, this);
    land_srv = nh.advertiseService("uavlab411/land", &OffBoardOut::Land, this);
    telemetry_srv = nh.advertiseService("uavlab411/telemetry", &OffBoardOut::GetTelemetry, this);
    set_velocity_srv = nh.advertiseService("uavlab411/set_velocity", &OffBoardOut::SetVelocity, this);
    ...
    setpoint_timer = nh.createTimer(ros::Duration(1.0 / update_frequency),
                                    boost::bind(&OffBoardOut::publish_point, this),
                                    false, false);
}

void OffBoardOut::handleState(const mavros_msgs::State::ConstPtr &msg)
{
    cur_state = *msg;
}

void OffBoardOut::handlePoses(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
    _uavpose = *msg;
}

void OffBoardOut::handleLocalPosition(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
    _uavpose_local_position = *msg;
}

void OffBoardOut::handleGlobalPosition(const sensor_msgs::NavSatFix::ConstPtr &msg)
{
    _globalPos = *msg;
}
void OffBoardOut::handleRelativeAlt(const std_msgs::Float64::ConstPtr &msg)
{
    z_relative = msg->data;
}
void OffBoardOut::handleImuData(const sensor_msgs::Imu::ConstPtr &msg)
{
    tf::Quaternion q(
        msg->orientation.x,
        msg->orientation.y,
...
void OffBoardOut::offboardAndArm()
{
    ros::Rate r(10);
...
void OffBoardOut::publish_point()
{
    switch (_curMode)
    {
...
void OffBoardOut::holdMode()
{
    pub_pointMessage.publish(_pointMessage);
}

void OffBoardOut::getCurrentPosition()
{
...
void OffBoardOut::navToWaypoint(float x, float y, float z, int rate)
{
    float _targetYaw;
    float _targetVx;
    float _targetVz;
...
void OffBoardOut::navToWayPointV2(float x, float y, float z, int rate)
{
...
void OffBoardOut::navToGPSPoint(const ros::Time &stamp, float speed)
{
...
bool OffBoardOut::GetTelemetry(uavlab411::Telemetry::Request &req, uavlab411::Telemetry::Response &res)
{
    res.x = NAN;
    res.y = NAN;
    res.z = NAN;
...
bool OffBoardOut::Navigate(uavlab411::Navigate::Request &req, uavlab411::Navigate::Response &res)
{
...
bool OffBoardOut::NavigateGlobal(uavlab411::NavigateGlobal::Request &req,
...
bool OffBoardOut::TakeoffSrv(uavlab411::Takeoff::Request &req, uavlab411::Takeoff::Response &res)
{
...
bool OffBoardOut::Land(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res)
{
    try
    {
        static mavros_msgs::SetMode sm;
...
bool OffBoardOut::TuningPID(uavlab411::PidTuning::Request &req, uavlab411::PidTuning::Response &res)
{
    switch (req.type)
    {
...
bool OffBoardOut::SetVelocity(uavlab411::SetVelocity::Request &req, uavlab411::SetVelocity::Response &res)
{
    if (checkState())
    {
        vx = req.vx;
...
float OffBoardOut::PidControl_yaw(float x_cur, float y_cur, float x_goal, float y_goal, float alpha, float dt)
{
...
float OffBoardOut::PidControl_vx(float x_cur, float y_cur, float x_goal, float y_goal, float dt)
{
    float e_x;
    float e_y;
...
void OffBoardOut::get_Distance_Azimuth(const geometry_msgs::Point &from, const geometry_msgs::Point &to)
{
}

//---------------------------------------------> Indoor <----------------------------

OffBoardIn::OffBoardIn()
{
    sub_state = nh.subscribe<mavros_msgs::State>("mavros/state", 1, &OffBoardIn::handleState, this);
    sub_uavpose = nh.subscribe<geometry_msgs::PoseStamped>("uavlab411/uavpose", 1, &OffBoardIn::handlePoses, this);
    sub_local_position = nh.subscribe<geometry_msgs::PoseStamped>("mavros/local_position/pose", 1, &OffBoardIn::handleLocalPosition, this);
    sub_global_position = nh.subscribe<sensor_msgs::NavSatFix>("/mavros/global_position/global", 1, &OffBoardIn::handleGlobalPosition, this);
    ...
    navigate_srv = nh.advertiseService("uavlab411/navigate", &OffBoardIn::Navigate, this);
    navigateGlobal_srv = nh.advertiseService("uavlab411/navigate_global", &OffBoardIn::NavigateGlobal, this);
    pid_tuning_srv = nh.advertiseService("uavlab411/pid_tuning", &OffBoardIn::TuningPID, this);
    takeoff_srv = nh.advertiseService("uavlab411/takeoff", &OffBoardIn::TakeoffSrv, this);
    land_srv = nh.advertiseService("uavlab411/land", &OffBoardIn::Land, this);
    telemetry_srv = nh.advertiseService("uavlab411/telemetry", &OffBoardIn::GetTelemetry, this);
    ...
    _navMessage.coordinate_frame = PositionTarget::FRAME_BODY_NED;
    setpoint_timer = nh.createTimer(ros::Duration(1.0 / update_frequency),
                                    boost::bind(&OffBoardIn::publish_point, this),
                                    false, false);
}

void OffBoardIn::handleState(const mavros_msgs::State::ConstPtr &msg)
{
    cur_state = *msg;
}

void OffBoardIn::handlePoses(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
    _uavpose = *msg;
}

void OffBoardIn::handleLocalPosition(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
    _uavpose_local_position = *msg;
}

void OffBoardIn::handleGlobalPosition(const sensor_msgs::NavSatFix::ConstPtr &msg)
{
    _globalPos = *msg;
}

void OffBoardIn::offboardAndArm()
{
    ros::Rate r(10);
...
void OffBoardIn::getCurrentPosition()
{
...
void OffBoardIn::navToWaypoint(float x, float y, float z, int rate)
{
    float _targetYaw;
    float _targetVx;
    float _targetVz;
...
void OffBoardIn::navToWayPointV2(float x, float y, float z, int rate)
{
    float _targetV, Vx, Vy, Vz, e_x, e_y, alpha_g, yaw;
...
bool OffBoardIn::GetTelemetry(uavlab411::Telemetry::Request &req, uavlab411::Telemetry::Response &res)
{
    res.x = NAN;
    res.y = NAN;
    res.z = NAN;
...
bool OffBoardIn::Navigate(uavlab411::Navigate::Request &req, uavlab411::Navigate::Response &res)
{
    if (!TIMEOUT(_uavpose, _uavpose_timemout) && !TIMEOUT(_uavpose_local_position, _uavpose_local_position_timeout) && checkState())
    {
        tolerance = req.tolerance == 0 ? tolerance : req.tolerance;
...
bool OffBoardIn::NavigateGlobal(uavlab411::NavigateGlobal::Request &req,
                              uavlab411::NavigateGlobal::Response &res)
{
    if (checkState())
    {
...
bool OffBoardIn::TakeoffSrv(uavlab411::Takeoff::Request &req, uavlab411::Takeoff::Response &res)
{
    ROS_INFO("TAKE OFF MODE");
    publish_point();
    setpoint_timer.start();
...
bool OffBoardIn::Land(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res)
{
    try
    {
        static mavros_msgs::SetMode sm;
...
bool OffBoardIn::TuningPID(uavlab411::PidTuning::Request &req, uavlab411::PidTuning::Response &res)
{
    switch (req.type)
    {
    case 0: // Tuning yawrate PID
...
float OffBoardIn::PidControl_yaw(float x_cur, float y_cur, float x_goal, float y_goal, float alpha, float dt)
{
...
float OffBoardIn::PidControl_vx(float x_cur, float y_cur, float x_goal, float y_goal, float dt)
{
    float e_x;
    float e_y;
    float Error_pre = Error_vx;
...
float OffBoardIn::getNavigateSetpoint(const ros::Time &stamp, float speed, mavros_msgs::GlobalPositionTarget &nav_setpoint)
{
