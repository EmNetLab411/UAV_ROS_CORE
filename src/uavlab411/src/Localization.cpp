...
void handle_global_position_local (const nav_msgs::Odometry &odom)
{
...
int main(int argc, char **argv)
{
    ...
    auto sub_global_position_local = nh.subscribe("/mavros/global_position/local",1,&handle_global_position_local);
    // Publish
