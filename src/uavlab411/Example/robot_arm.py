...
def callback(control_robot):
    Pstep1 = 120 + (180 - control_robot.step1)* 430 / 180
    Pstep2 = 100 + control_robot.step2 * 450 / 180
    Pstep3 = 120 + (180 - control_robot.step3) * 480 / 180
    Pstep4 = 130 + control_robot.step4 * 470 / 180
    Pstep5 = 400 - control_robot.step5 * 230
    global stamp
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("time now ",rospy.Time.now().secs )
        print("stamp ", stamp)
        if timeOut >= 3:
            pwm = Adafruit_PCA9685.PCA9685()
    rospy.spin()
